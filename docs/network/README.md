...
## 输入url发生了什么 或者 用户在浏览器输入网址后到呈现页面的详细步骤  4次
## http和https的区别
## 三次握手四次挥手，拥塞控制
## arp协议
## 计网转发分组的详细过程
...
## 网络连接的各层的状态
## 说一下URL的格式，越详细越好
## http的请求方法有哪些 ![Q1BBEG](https://cdn.jsdelivr.net/gh/sivanWu0222/ImageHosting@master/uPic/Q1BBEG.png)
## 网络中的状态码：![jcVmoh](https://cdn.jsdelivr.net/gh/sivanWu0222/ImageHosting@master/uPic/jcVmoh.png)
## get与post的区别 
